tldr;
Windows service manager (AMD64) to easily run the beholder API as a service on Windows. The nssm.exe is the prelease build 2.2.4-101.

Usage  http://www.nssm.cc/usage

----
Info at http://www.nssm.cc/download:
